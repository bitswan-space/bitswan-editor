...
export const JVSC_EXTENSION_ID = 'LibertyAcesLtd.bitswan-jupyter';
...
export const JUPYTER_HUB_EXTENSION_ID = 'LibertyAcesLtd.bitswan-jupyter-hub';
...
export const RendererExtension = 'LibertyAcesLtd.bitswan-jupyter-renderers';
